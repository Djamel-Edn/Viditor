    ...
    <div className='flex flex-col mx-4 lg:mx-16 border-2 border-blue-900 bg-blue-950 rounded-3xl shadow-inner shadow-blue-900'>
      <div className='grid md:grid-cols-2 pt-8 md:pt-0'>
        {featureCards.map((feature, index) => (
          <FeatureCard key={index} icon={feature.icon} slogan={feature.slogan} heading={feature.heading} text={feature.text} buttonIcon={feature.buttonIcon} buttonText={feature.buttonText}/>
        ))}
      </div>
